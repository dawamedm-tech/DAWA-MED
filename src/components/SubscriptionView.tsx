...
export const SubscriptionView: React.FC<SubscriptionViewProps> = ({
  ...
  const getStatusBadge = (status: DawaMonthlySubscription['status']) => {
    switch (status) {
      case 'active':
        return (
          <span className="px-3 py-1 rounded-full text-xs font-black bg-[#D8F3DC] text-[#2D6A4F] border border-[#74C69D] inline-flex items-center gap-1.5">
  ...
  return (
    <div className="space-y-6" id="subscription-view-root">
      ...
      <div className="bg-[#1B4332] text-white rounded-3xl p-6 sm:p-8 shadow-sm border border-[#2D6A4F]/40 relative overflow-hidden">
        <div className="relative z-10 space-y-4 max-w-3xl">
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-[#74C69D] text-xs font-black border border-white/15">
              <Sparkles className="w-3.5 h-3.5" />
              <span>DAWA MED MONTHLY</span>
            </span>
            <span className="px-3 py-1 rounded-full bg-emerald-500/20 text-[#D8F3DC] text-xs font-bold border border-emerald-400/30">
          ...
          <p className="text-xs sm:text-sm text-[#D8F3DC]/90 leading-relaxed max-w-2xl">
            {t.subHeroSubtitle}
          </p>
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3">
            {!isSubscribed ? (
              <button
                ...
                className="px-6 py-3 rounded-2xl bg-[#52B788] hover:bg-[#74C69D] text-[#1B4332] font-black text-xs sm:text-sm shadow-md transition-all active:scale-95 flex items-center gap-2 cursor-pointer"
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-2xl bg-white text-[#1B4332] font-black text-xs sm:text-sm shadow-md transition-all active:scale-95 flex items-center gap-2 cursor-pointer"
              >
            ...
            <button
              ...
              className="px-4 py-3 rounded-2xl bg-white/10 hover:bg-white/20 text-[#D8F3DC] font-bold text-xs border border-white/15 transition-colors flex items-center gap-2 cursor-pointer"
              id="hero-invite-friends-btn"
            >
              <Gift className="w-4 h-4 text-[#74C69D]" />
      ...
      <div className="p-4 rounded-3xl bg-[#F0F7F4] border border-[#74C69D]/40 text-[#1B4332] flex items-start gap-3 shadow-xs">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#D8E2DC] pb-2">
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-2xl font-bold text-xs transition-all cursor-pointer flex items-center gap-2 ${
              activeTab === 'reminders'
                ...
                : 'bg-white text-gray-600 hover:bg-[#F8FAF9] border border-[#D8E2DC]'
            }`}
            id="tab-reminders"
          >
        ...
        <button
          ...
          className="px-4 py-2 rounded-2xl bg-[#2D6A4F] hover:bg-[#1B4332] text-white font-bold text-xs flex items-center gap-1.5 cursor-pointer shadow-xs"
        >
          <Plus className="w-4 h-4" />
          <span>{t.addMedicine}</span>
        </button>
            ...
            <button
              ...
              className={`px-3 py-1 rounded-full text-xs font-bold transition-all shrink-0 cursor-pointer ${
                selectedFamilyFilter === 'all'
                  ...
                  : 'bg-white text-gray-600 border border-[#D8E2DC] hover:bg-gray-50'
              }`}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
              {filteredReminders.length === 0 ? (
                <div className="bg-white rounded-3xl border border-[#D8E2DC] p-10 text-center space-y-3">
                  <Pill className="w-10 h-10 text-[#2D6A4F] mx-auto opacity-40" />
                  <h3 className="text-sm font-black text-[#1B4332]">No medicines scheduled</h3>
                  <p className="text-xs text-gray-500 max-w-sm mx-auto">
                    Add your prescribed medication schedules to receive daily dose alerts and refill reminders.
                  </p>
                  <button
                    onClick={() => setShowAddMedicineModal(true)}
                    className="px-5 py-2.5 rounded-2xl bg-[#2D6A4F] text-white font-bold text-xs"
                  >
                ...
                filteredReminders.map((reminder) => {
                  ...
                  return (
                    <div
                      key={reminder.id}
                      className="bg-white rounded-3xl border border-[#D8E2DC] p-5 sm:p-6 shadow-xs space-y-4 hover:border-[#52B788] transition-all relative overflow-hidden"
                      id={`reminder-card-${reminder.id}`}
                    >
                      {/* Top Row */}
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 border-b border-[#E9F5EE] pb-3">
                        <div className="space-y-1">
                          <div className="flex flex-wrap items-center gap-2">
                            <span className="text-[10px] font-black uppercase px-2.5 py-0.5 rounded-full bg-[#E9F5EE] text-[#2D6A4F] border border-[#D8E2DC]">
                        ...
                        <div className="flex items-center gap-1.5 self-end sm:self-start">
                          <button
                            ...
                            className="p-2 rounded-xl text-gray-500 hover:bg-[#E9F5EE] hover:text-[#2D6A4F] transition-colors"
                            title="Edit schedule"
                          >
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="p-3 rounded-2xl bg-[#F8FAF9] border border-[#D8E2DC] space-y-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2 pt-1">
                          ...
                          {reminder.reminderTimes.map((time) => (
                            <span
                              key={time}
                              className="px-2.5 py-1 rounded-xl bg-white border border-[#D8E2DC] shadow-2xs font-bold text-[#1B4332] flex items-center gap-1"
                            >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 text-xs">
                        <div className="p-3 rounded-2xl bg-[#F8FAF9] border border-[#D8E2DC] flex items-center justify-between">
                          <div>
                            <span className="text-[10px] uppercase font-bold text-gray-400 block">
                          ...
                          <div className={`h-8 w-8 rounded-xl flex items-center justify-center font-bold text-xs ${
                            isLow ? 'bg-amber-100 text-amber-800' : 'bg-[#D8F3DC] text-[#2D6A4F]'
                          }`}>
                      ...
                      <div className="pt-2 flex flex-wrap items-center justify-between gap-2 border-t border-[#E9F5EE]">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 rounded-xl bg-white border border-[#D8E2DC] hover:bg-[#F8FAF9] text-[#1B4332] font-bold text-xs flex items-center gap-1 cursor-pointer"
                          >
                          ...
                          <button
                            ...
                            className="px-4 py-1.5 rounded-xl bg-[#2D6A4F] hover:bg-[#1B4332] text-white font-black text-xs flex items-center gap-1.5 cursor-pointer shadow-xs transition-transform active:scale-95"
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#1B4332] text-white rounded-3xl p-6 border border-[#2D6A4F]/40 space-y-4 shadow-xs">
                ...
                <div className="space-y-1">
                  <p className="text-4xl font-black text-[#74C69D]">{adherencePercent}%</p>
                ...
                <div className="p-3.5 rounded-2xl bg-white/10 border border-white/15 text-xs space-y-1.5">
                  <div className="flex justify-between text-[#D8F3DC]">
              ...
              <div className="bg-white rounded-3xl border border-[#D8E2DC] p-6 shadow-xs space-y-3">
                <div className="flex items-center justify-between border-b border-[#E9F5EE] pb-3">
                  <h4 className="text-xs font-black text-[#1B4332] uppercase">
                    Plan Status
                  </h4>
                ...
                <div className="space-y-2 text-xs">
                  <div className="flex justify-between text-gray-600">
                    ...
                    <strong className="text-[#1B4332]">DAWA MED MONTHLY</strong>
                  </div>
                  <div className="flex justify-between text-gray-600">
                    <span>Monthly Cost:</span>
                    <strong className="text-[#2D6A4F]">$5.00 USD / month</strong>
                  </div>
                  {dawaSubscription && (
                    <div className="flex justify-between text-gray-600">
                      <span>Next Billing:</span>
                      <strong className="text-[#1B4332]">{dawaSubscription.renewalDate}</strong>
                    </div>
                  )}
                </div>
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-2xl bg-[#F0F7F4] hover:bg-[#E9F5EE] text-[#2D6A4F] font-bold text-xs border border-[#D8E2DC] transition-colors cursor-pointer text-center block mt-2"
                >
        ...
        <div className="space-y-6">
          {dawaSubscription ? (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 bg-white rounded-3xl border border-[#D8E2DC] p-6 sm:p-8 shadow-xs space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E9F5EE] pb-4">
                  <div>
                    <span className="text-[10px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-[#E9F5EE] text-[#2D6A4F] border border-[#D8E2DC]">
                      {t.currentPlan}
                    </span>
                    <h2 className="text-xl font-black text-[#1B4332] mt-1">
                      {dawaSubscription.planName}
                    </h2>
                    <p className="text-xs text-gray-500">
                      Subscribed for Patient: <strong className="text-[#1B4332]">{dawaSubscription.userName}</strong>
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                  <div className="p-4 rounded-2xl bg-[#F8FAF9] border border-[#D8E2DC] space-y-1">
                  ...
                  <div className="p-4 rounded-2xl bg-[#F8FAF9] border border-[#D8E2DC] space-y-1">
                    ...
                    <p className="text-[10px] text-[#2D6A4F] font-mono">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-[#E9F5EE]">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => setShowSubscribeModal(true)}
                      className="px-4 py-2.5 rounded-2xl bg-[#2D6A4F] hover:bg-[#1B4332] text-white font-bold text-xs flex items-center gap-2 transition-colors cursor-pointer"
                    >
                    ...
                    {dawaSubscription.status === 'cancelled' && (
                      <button
                        ...
                        className="px-4 py-2.5 rounded-2xl bg-[#52B788] text-white font-bold text-xs transition-colors cursor-pointer"
                      >
                        {t.renewSubscription}
                      </button>
                    )}
              ...
              <div className="bg-white rounded-3xl border border-[#D8E2DC] p-6 shadow-xs space-y-4">
                <div className="flex items-center justify-between border-b border-[#E9F5EE] pb-3">
                  <h3 className="font-black text-sm text-[#1B4332] flex items-center gap-2">
                ...
                <div className="space-y-2 max-h-[350px] overflow-y-auto text-xs">
                  {dawaSubscription.billingHistory.length === 0 ? (
                    ...
                    dawaSubscription.billingHistory.map((bill) => (
                      <div
                        key={bill.id}
                        className="p-3 rounded-2xl bg-[#F8FAF9] border border-[#D8E2DC] space-y-1"
                      >
                        <div className="flex justify-between items-center font-bold">
                          <span className="text-[#1B4332]">{bill.receiptNumber}</span>
                          <span className="text-[#2D6A4F]">${bill.amountUSD.toFixed(2)} USD</span>
                        </div>
                        <div className="flex justify-between items-center text-[10px] text-gray-500">
                          <span>{bill.date}</span>
                          <span className="px-2 py-0.5 rounded-md bg-[#D8F3DC] text-[#2D6A4F] font-bold">
            ...
            <div className="bg-white rounded-3xl border border-[#D8E2DC] p-10 text-center space-y-4 max-w-md mx-auto">
              <Sparkles className="w-12 h-12 text-[#2D6A4F] mx-auto opacity-80" />
              <div className="space-y-1">
                <h3 className="text-lg font-black text-[#1B4332]">No Active Subscription</h3>
              ...
              <button
                onClick={() => setShowSubscribeModal(true)}
                className="px-6 py-3 rounded-2xl bg-[#1B4332] hover:bg-[#2D6A4F] text-white font-bold text-xs"
              >
      ...
      {activeTab === 'adherence_history' && (
        <div className="bg-white rounded-3xl border border-[#D8E2DC] p-6 sm:p-8 shadow-xs space-y-6">
          <div className="flex items-center justify-between border-b border-[#E9F5EE] pb-4">
            <div>
            ...
            <span className="text-xs font-black text-[#2D6A4F] px-3 py-1 bg-[#E9F5EE] rounded-full">
              {adherencePercent}% Adherence Rate
            </span>
          </div>

          <div className="divide-y divide-[#E9F5EE] text-xs">
                ...
                .map((log) => (
                  <div key={log.id} className="py-3 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-bold text-[#1B4332]">{log.medicineName}</p>
      ...
      {activeTab === 'features' && (
        <div className="space-y-6">
          <div className="text-center max-w-xl mx-auto space-y-2">
            <span className="px-3 py-1 rounded-full bg-[#E9F5EE] text-[#2D6A4F] text-xs font-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-xs">
            {[
              ...
              <div
                key={idx}
                className="bg-white rounded-3xl border border-[#D8E2DC] p-5 shadow-2xs space-y-2 hover:border-[#52B788] transition-all"
              >
                <div className="flex items-center gap-2 text-[#2D6A4F]">
                  <CheckCircle2 className="w-4 h-4 shrink-0" />
                  <h4 className="font-black text-[#1B4332] text-sm">{feat.title}</h4>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs">
          ...
          >
            ...
            <div className="text-center space-y-1">
              <h3 className="text-base font-black text-[#1B4332]">Cancel Subscription?</h3>
            ...
            <div className="flex justify-end gap-2 pt-2">
              <button
                ...
                className="px-4 py-2.5 rounded-xl border border-[#D8E2DC] bg-gray-50 hover:bg-gray-100 font-bold"
              >
                Keep Active
              </button>
              <button
