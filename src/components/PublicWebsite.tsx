...
export const PublicWebsite: React.FC<PublicWebsiteProps> = ({
  ...
  return (
    <div className="bg-[#F1FAF4] text-[#111827] min-h-screen flex flex-col font-['Plus_Jakarta_Sans',sans-serif]" id="dawa-public-website">
      {/* 1. Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[#0E7A4B] via-[#0B6B43] to-[#0E7A4B] text-white pt-12 pb-20 px-4 sm:px-6">
        {/* Subtle glowing ambient circles */}
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#E8F5EE]/20 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-1/3 w-80 h-80 bg-[#E8F5EE]/20 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-start">
              {/* Trust Badge */}
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-xs font-bold text-white/80">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-[#0E7A4B] hover:bg-[#0B6B43] text-[#111827] font-black text-base transition-all transform hover:-translate-y-0.5 shadow-xl flex items-center justify-center gap-2.5 cursor-pointer"
              ...
              {/* Guarantees row */}
              <div className="pt-6 grid grid-cols-1 sm:grid-cols-3 gap-3 border-t border-white/10 text-xs text-white/80">
            ...
            <div className="lg:col-span-5">
              <div className="bg-white rounded-3xl p-6 text-[#111827] shadow-2xl border border-white/20 space-y-4">
                <div className="flex items-center justify-between border-b border-[#E8F5EE] pb-3">
                  <div className="flex items-center gap-2">
                    <BrandLogo className="w-8 h-8" />
                    <div>
                      <h3 className="font-black text-sm text-[#111827]">DAWA MED Direct</h3>
                ...
                <div 
                  onClick={onOpenCustomerApp}
                  className="p-3 bg-[#F1FAF4] rounded-2xl border border-[#E8F5EE] flex items-center justify-between cursor-pointer hover:border-[#D0EADB] transition-colors"
                >
                  <div className="flex items-center gap-2 text-xs text-gray-400">
                    <Search className="w-4 h-4 text-gray-400" />
                    <span>{isAr ? 'ابحث عن الأدوية (مثل Metformin, Panadol)...' : 'Search medicines (e.g. Panadol, Inhaler)...'}</span>
                  </div>
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-white text-[#111827] border border-[#E8F5EE]">
                    Explore
                  </span>
                </div>
                  ...
                  <div className="space-y-2">
                    {sampleMedicines.slice(0, 3).map((med) => (
                      <div 
                        key={med.id}
                        onClick={onOpenCustomerApp}
                        className="p-2.5 rounded-xl border border-[#E8F5EE] hover:bg-[#F1FAF4] flex items-center justify-between transition-colors cursor-pointer text-xs"
                      >
                        <div>
                          <p className="font-bold text-[#111827]">{med.name}</p>
                          <p className="text-[10px] text-gray-500">{med.dosage} • {med.packageSize}</p>
                        </div>
                        <div className="text-right">
                          <p className="font-black text-[#0E7A4B]">
                ...
                <div 
                  ...
                  className="p-3 bg-[#E8F5EE] border border-[#D0EADB] rounded-2xl flex items-center justify-between cursor-pointer hover:bg-[#E8F5EE] transition-colors"
                >
                  <div className="flex items-center gap-2">
                    <CalendarCheck className="w-4 h-4 text-[#0E7A4B]" />
                    <div className="text-xs">
                      <strong className="text-[#111827] block font-black">DAWA MED MONTHLY</strong>
                      <span className="text-[10px] text-gray-600">$5/mo Free delivery for chronic refills</span>
                    </div>
                  </div>
                  <ChevronRight className="w-4 h-4 text-[#0E7A4B]" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 max-w-7xl mx-auto w-full space-y-12">
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          <span className="px-3.5 py-1 rounded-full bg-[#E8F5EE] text-[#0E7A4B] text-xs font-black tracking-wider uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Step 1 */}
          <div className="bg-white p-6 rounded-3xl border border-[#E8F5EE] shadow-xs space-y-3 relative group hover:border-[#D0EADB] transition-all">
            <div className="w-12 h-12 rounded-2xl bg-[#E8F5EE] text-[#0E7A4B] flex items-center justify-center font-black text-lg">
              1
            </div>
      ...
      <section className="bg-white py-16 px-4 sm:px-6 border-y border-[#E8F5EE]">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-[#0E7A4B] via-[#0B6B43] to-[#0E7A4B] rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#E8F5EE] border border-[#D0EADB]/40 text-xs font-bold text-emerald-400">
                  <Sparkles className="w-3.5 h-3.5" />
                  <span>{isAr ? 'برنامج الرعاية الدوائية المزمنة' : 'Chronic Care Adherence Membership'}</span>
                </div>

                <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
                  DAWA MED MONTHLY — <span className="text-emerald-400">$5.00 / month</span>
                </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-3 text-xs text-white/80">
                  <div className="flex items-center gap-2">
              ...
              <div className="lg:col-span-4 text-center lg:text-right">
                <button
                  onClick={onOpenMonthlySub}
                  className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-[#0E7A4B] hover:bg-[#0B6B43] text-[#111827] font-black text-sm transition-all transform hover:-translate-y-0.5 shadow-xl inline-flex items-center justify-center gap-2 cursor-pointer"
                >
      ...
      <section className="py-16 px-4 sm:px-6 max-w-7xl mx-auto w-full space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-3xl border border-[#E8F5EE] shadow-xs space-y-3">
      ...
      <section className="bg-white py-16 px-4 sm:px-6 border-y border-[#E8F5EE]" id="partner-section">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="max-w-2xl mx-auto bg-[#F1FAF4] rounded-3xl border border-[#E8F5EE] p-6 sm:p-8 shadow-xs">
            {/* Toggle Partner Type */}
            <div className="flex bg-[#E8F5EE] p-1.5 rounded-2xl gap-2 mb-6">
              <button
                ...
                className={`flex-1 py-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-center gap-2 ${
                  partnerType === 'pharmacy' ? 'bg-[#0E7A4B] text-white shadow-xs' : 'text-[#0E7A4B]'
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 py-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-center gap-2 ${
                  partnerType === 'driver' ? 'bg-[#0E7A4B] text-white shadow-xs' : 'text-[#0E7A4B]'
                }`}
              >
            ...
            {partnerFormSubmitted ? (
              <div className="text-center py-8 space-y-3">
                ...
                <button
                  ...
                  className="mt-4 px-4 py-2 rounded-xl bg-[#0E7A4B] text-white text-xs font-bold cursor-pointer"
                >
              ...
              <form onSubmit={handlePartnerSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-[#E8F5EE] bg-white focus:outline-none focus:border-[#0E7A4B]"
                    />
                  </div>
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-2xl bg-[#0E7A4B] hover:bg-[#0B6B43] text-white font-black text-xs transition-all cursor-pointer shadow-xs flex items-center justify-center gap-2"
                >
        ...
        <div className="space-y-3">
          {faqs.map((faq, idx) => {
            ...
            return (
              <div 
                key={`faq-${idx}`}
                className="bg-white rounded-2xl border border-[#E8F5EE] overflow-hidden transition-all"
              >
                <button
                  onClick={() => setOpenFaqIndex(isOpen ? null : idx)}
                  className="w-full p-4 sm:p-5 text-start flex items-center justify-between gap-4 font-bold text-sm text-[#111827] hover:bg-[#F1FAF4] transition-colors cursor-pointer"
                >
                  <span>{isAr ? faq.qAr : faq.qEn}</span>
                  <ChevronDown className={`w-4 h-4 text-gray-500 transition-transform ${isOpen ? 'rotate-180 text-[#0E7A4B]' : ''}`} />
                </button>
                {isOpen && (
                  <div className="p-4 sm:p-5 pt-0 text-xs text-gray-600 border-t border-[#E8F5EE] leading-relaxed bg-[#F1FAF4]">
      ...
      <section className="bg-white py-16 px-4 sm:px-6 border-t border-[#E8F5EE]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <a
                ...
                className="p-4 bg-emerald-50 border border-[#D0EADB] rounded-2xl flex items-center justify-between text-emerald-900 hover:bg-emerald-100 transition-colors"
              >
              ...
              <div className="flex items-center gap-3 p-4 bg-[#F1FAF4] rounded-2xl border border-[#E8F5EE] text-xs">
                <Mail className="w-5 h-5 text-[#0E7A4B]" />
                <div>
                  <strong className="block text-[#111827]">Email Desk</strong>
          ...
          <div className="bg-[#F1FAF4] p-6 sm:p-8 rounded-3xl border border-[#E8F5EE]">
            {contactSubmitted ? (
              <div className="text-center py-8 space-y-3">
              ...
              <form onSubmit={handleContactSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-2xl bg-[#0E7A4B] hover:bg-[#0B6B43] text-white font-black text-xs transition-colors cursor-pointer"
                >
